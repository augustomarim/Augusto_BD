...
alter table FILIAIS add ABC INT;
alter table FILIAIS modify column ABC VARCHAR(10);
alter table FILIAIS change column ABC ABCD VARCHAR(10);
alter table FILIAIS drop column ABCD;
alter table PEDIDOS add ABC INT;
alter table PEDIDOS modify column ABC VARCHAR(10);
alter table PEDIDOS change column ABC ABCD VARCHAR(10);
alter table PEDIDOS drop column ABCD;
alter table RECEBIMENTOS add ABC INT;
alter table RECEBIMENTOS modify column ABC VARCHAR(10);
alter table RECEBIMENTOS change column ABC ABCD VARCHAR(10);
alter table RECEBIMENTOS drop column ABCD;
alter table PEDIDOS_PRODUTOS add ABC INT;
alter table PEDIDOS_PRODUTOS  modify column ABC VARCHAR(10);
alter table PEDIDOS_PRODUTOS change column ABC ABCD VARCHAR(10);
alter table PEDIDOS_PRODUTOS drop column ABCD;
alter table FILIAIS_PRODUTOS add ABC INT;
alter table FILIAIS_PRODUTOS modify column ABC VARCHAR(10);
alter table FILIAIS_PRODUTOS change column ABC ABCD VARCHAR(10);
alter table FILIAIS_PRODUTOS drop column ABCD;
alter table FORNECEDORES_PRODUTOS add ABC INT;
alter table FORNECEDORES_PRODUTOS modify column ABC VARCHAR(10);
alter table FORNECEDORES_PRODUTOS change column ABC ABCD VARCHAR(10);
alter table FORNECEDORES_PRODUTOS drop column ABCD;
