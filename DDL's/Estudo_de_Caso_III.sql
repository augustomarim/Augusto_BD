...
ALTER TABLE TIPO_COMPONENTES ADD ABC INT;
ALTER TABLE TIPO_COMPONENTES MODIFY COLUMN ABC VARCHAR(10);
ALTER TABLE TIPO_COMPONENTES CHANGE COLUMN ABC ABCD VARCHAR(10);
ALTER TABLE TIPO_COMPONENTES DROP COLUMN ABCD;
ALTER TABLE COMPONENTES ADD ABC INT;
ALTER TABLE COMPONENTES MODIFY COLUMN ABC VARCHAR(10);
ALTER TABLE COMPONENTES CHANGE COLUMN ABC ABCD VARCHAR(10);
ALTER TABLE COMPONENTES DROP COLUMN ABCD;
ALTER TABLE MAQUINAS ADD ABC INT;
ALTER TABLE MAQUINAS MODIFY COLUMN ABC VARCHAR(10);
ALTER TABLE MAQUINAS CHANGE COLUMN ABC ABCD VARCHAR(10);
ALTER TABLE MAQUINAS DROP COLUMN ABCD;
ALTER TABLE RECURSOS_ESPECIFICOS ADD ABC INT;
ALTER TABLE RECURSOS_ESPECIFICOS MODIFY COLUMN ABC VARCHAR(10);
ALTER TABLE RECURSOS_ESPECIFICOS CHANGE COLUMN ABC ABCD VARCHAR(10);
ALTER TABLE RECURSOS_ESPECIFICOS DROP COLUMN ABCD;
ALTER TABLE CARGOS ADD ABC INT;
ALTER TABLE CARGOS MODIFY COLUMN ABC VARCHAR(10);
ALTER TABLE CARGOS CHANGE COLUMN ABC ABCD VARCHAR(10);
ALTER TABLE CARGOS DROP COLUMN ABCD;
ALTER TABLE FUNCOES ADD ABC INT;
ALTER TABLE FUNCOES MODIFY COLUMN ABC VARCHAR(10);
ALTER TABLE FUNCOES CHANGE COLUMN ABC ABCD VARCHAR(10);
ALTER TABLE FUNCOES DROP COLUMN ABCD;
ALTER TABLE ENCOMENDAS ADD ABC INT;
ALTER TABLE ENCOMENDAS MODIFY COLUMN ABC VARCHAR(10);
ALTER TABLE ENCOMENDAS CHANGE COLUMN ABC ABCD VARCHAR(10);
ALTER TABLE ENCOMENDAS DROP COLUMN ABCD;
...
ALTER TABLE REGISTRO_MANUTENCAO ADD ABC INT;
ALTER TABLE REGISTRO_MANUTENCAO MODIFY COLUMN ABC VARCHAR(10);
ALTER TABLE REGISTRO_MANUTENCAO CHANGE COLUMN ABC ABCD VARCHAR(10);
ALTER TABLE REGISTRO_MANUTENCAO DROP COLUMN ABCD;
ALTER TABLE REGISTRO_SUPRIMENTOS ADD ABC INT;
ALTER TABLE REGISTRO_SUPRIMENTOS MODIFY COLUMN ABC VARCHAR(10);
ALTER TABLE REGISTRO_SUPRIMENTOS CHANGE COLUMN ABC ABCD VARCHAR(10);
ALTER TABLE REGISTRO_SUPRIMENTOS DROP COLUMN ABCD;
ALTER TABLE PESSOA_CONTATO ADD ABC INT;
ALTER TABLE PESSOA_CONTATO MODIFY COLUMN ABC VARCHAR(10);
ALTER TABLE PESSOA_CONTATO CHANGE COLUMN ABC ABCD VARCHAR(10);
ALTER TABLE PESSOA_CONTATO DROP COLUMN ABCD;
ALTER TABLE CARGOS_FUNCOES ADD ABC INT;
ALTER TABLE CARGOS_FUNCOES MODIFY COLUMN ABC VARCHAR(10);
ALTER TABLE CARGOS_FUNCOES CHANGE COLUMN ABC ABCD VARCHAR(10);
ALTER TABLE CARGOS_FUNCOES DROP COLUMN ABCD;
ALTER TABLE EMPREGADOS ADD ABC INT;
ALTER TABLE EMPREGADOS MODIFY COLUMN ABC VARCHAR(10);
ALTER TABLE EMPREGADOS CHANGE COLUMN ABC ABCD VARCHAR(10);
ALTER TABLE EMPREGADOS DROP COLUMN ABCD;
ALTER TABLE TELEFONES ADD ABC INT;
ALTER TABLE TELEFONES MODIFY COLUMN ABC VARCHAR(10);
ALTER TABLE TELEFONES CHANGE COLUMN ABC ABCD VARCHAR(10);
ALTER TABLE TELEFONES DROP COLUMN ABCD;
ALTER TABLE ENDERECOS ADD ABC INT;
ALTER TABLE ENDERECOS MODIFY COLUMN ABC VARCHAR(10);
ALTER TABLE ENDERECOS CHANGE COLUMN ABC ABCD VARCHAR(10);
ALTER TABLE ENDERECOS DROP COLUMN ABCD;
ALTER TABLE PRODUTOS_EMPREGADOS ADD ABC INT;
ALTER TABLE PRODUTOS_EMPREGADOS MODIFY COLUMN ABC VARCHAR(10);
ALTER TABLE PRODUTOS_EMPREGADOS CHANGE COLUMN ABC ABCD VARCHAR(10);
ALTER TABLE PRODUTOS_EMPREGADOS DROP COLUMN ABCD;
ALTER TABLE FORNECEDOR_COMPONENTE ADD ABC INT;
ALTER TABLE FORNECEDOR_COMPONENTE MODIFY COLUMN ABC VARCHAR(10);
ALTER TABLE FORNECEDOR_COMPONENTE CHANGE COLUMN ABC ABCD VARCHAR(10);
ALTER TABLE FORNECEDOR_COMPONENTE DROP COLUMN ABCD;
ALTER TABLE PRODUTOS_ENCOMENDA ADD ABC INT;
ALTER TABLE PRODUTOS_ENCOMENDA MODIFY COLUMN ABC VARCHAR(10);
ALTER TABLE PRODUTOS_ENCOMENDA CHANGE COLUMN ABC ABCD VARCHAR(10);
ALTER TABLE PRODUTOS_ENCOMENDA DROP COLUMN ABCD;
ALTER TABLE PRODUTOS_MAQUINA ADD ABC INT;
ALTER TABLE PRODUTOS_MAQUINA MODIFY COLUMN ABC VARCHAR(10);
ALTER TABLE PRODUTOS_MAQUINA CHANGE COLUMN ABC ABCD VARCHAR(10);
ALTER TABLE PRODUTOS_MAQUINA DROP COLUMN ABCD;
ALTER TABLE PRODUTOS_TIPO_COMPONENTE ADD ABC INT;
ALTER TABLE PRODUTOS_TIPO_COMPONENTE MODIFY COLUMN ABC VARCHAR(10);
ALTER TABLE PRODUTOS_TIPO_COMPONENTE CHANGE COLUMN ABC ABCD VARCHAR(10);
ALTER TABLE PRODUTOS_TIPO_COMPONENTE DROP COLUMN ABCD;
